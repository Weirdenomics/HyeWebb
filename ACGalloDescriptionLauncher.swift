...
class ACGalloDescriptionLauncher: ExecutiveBaseDescriptionLauncher{
    
    let positions: [Setting] = {
        return [Setting(name: "<"),Setting(name: "Whole Foods Market, President and COO"),Setting(name: "Weirdenomics, CEO")]
    }()
    ...
    var homeController: ACGalloViewController?
    ...
    override func handleDismiss(setting: Setting){
        UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 1, initialSpringVelocity: 1, options: .curveEaseOut, animations: {
            ...
            if setting.name == "Alphabet, Co-Founder"{
